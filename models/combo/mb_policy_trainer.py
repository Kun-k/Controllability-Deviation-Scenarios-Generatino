...
# from models.combo.utils.logger import Logger
from models.combo.policy.base_policy import BasePolicy
...
class MBPolicyTrainer:
    ...
    def _evaluate(self) -> Dict[str, List[float]]:
        ...
        while num_episodes < self._eval_episodes:
            action = self.policy.select_action(np.array(obs).reshape(1, -1), deterministic=True)
            next_obs, reward, terminal, _ = self.eval_env.step(None, action.flatten())
