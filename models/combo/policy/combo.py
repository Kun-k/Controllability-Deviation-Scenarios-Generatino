...
from models.combo.policy.cql import CQLPolicy
from models.combo.ensemble_dynamics import BaseDynamics
...
class COMBOPolicy(CQLPolicy):
    ...
    def learn(self, batch: Dict) -> Dict[str, float]:
        ...
        obss, actions, next_obss, rewards, terminals = mix_batch["observations"], mix_batch["actions"], \
            mix_batch["next_observations"], mix_batch["rewards"], mix_batch["dones"]
        ...
        ).uniform_(0, 1).to(self.actor.device)
