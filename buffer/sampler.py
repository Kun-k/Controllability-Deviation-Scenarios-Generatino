...
class StepSampler(object):
    ...
    def sample(self, ego_policy=None, adv_policy=None, n_steps=100, deterministic=False,
...
class TrajSampler(object):
    ...
    def sample(self, ego_policy=None, adv_policy=None, n_trajs=100, scenario=None, deterministic=False,
